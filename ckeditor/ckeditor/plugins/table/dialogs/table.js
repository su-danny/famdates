                ...
                {type: 'hbox', widths: [null, null], styles: ['vertical-align:top'], children: [
                    ...
                    {type: 'vbox', padding: 0, children: [
                        {type: 'hbox', widths: ['5em'], children: [
                            {type: 'text', id: 'txtWidth', controlStyle: 'width:5em', label: e.lang.common.width, title: e.lang.common.cssLengthTooltip, 'default': 500, getValue: a, validate: CKEDITOR.dialog.validate.cssLength(e.lang.common.invalidCssLength.replace('%1', e.lang.common.width)), onChange: function () {
