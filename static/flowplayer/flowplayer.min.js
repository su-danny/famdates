...
!function (e) {
    ...
    function a(e) {
        return/^(video|application)/.test(e) || (e = i(e)), !!m.canPlayType(e).replace("no", "")
    }
    ...
    function r(e) {
        var t = e.attr("src"), n = e.attr("type") || "", i = t.split(y)[1];
    ...
    function s(t) {
        ...
        e("source", t).each(function () {
            ...
            return t ? (e.isArray(t) ? t = {sources: e.map(t, function (t) {
                ...
                "flash" != n.type && t.sources.push({type: n.type, src: t.src.replace(y, "." + n.suffix + "$2")})
            })), t) : {sources: i}
        }
    }
    ...
    }), e.extend(flowplayer, {version: "5.4.2", engine: {}, conf: {}, support: {}, defaults: {debug: !1, disabled: !1, engine: "html5", fullscreen: window == window.top, keyboard: !0, ratio: 9 / 16, adaptiveRatio: !1, flashfit: !1, rtmp: 0, splash: !1, swf: "//releases.flowplayer.org/5.4.2/flowplayer.swf", speeds: [.25, .5, 1, 1.5, 2], tooltip: !0, volume: "object" != typeof localStorage ? 1 : "true" == localStorage.muted ? 0 : isNaN(localStorage.volume) ? 1 : localStorage.volume || 1, errors: ["", "Video loading aborted", "Network error", "Video not properly encoded", "Video file not found", "Unsupported video", "Skin not found", "SWF file not found", "Subtitles not found", "Invalid RTMP URL", "Unsupported video format. Try installing Adobe Flash."], errorUrls: ["", "", "", "", "", "", "", "", "", "", "http://get.adobe.com/flashplayer/"], playlist: []}});
    var p = 1;
    e.fn.flowplayer = function (t, n) {
        return"string" == typeof t && (t = {swf: t}), e.isFunction(t) && (n = t, t = {}), !t && this.data("flowplayer") || this.each(function () {
            ...
            if (r.playlist.length) {
                var v = l.attr("preload");
                l.remove(), l = e("<video />").addClass("fp-engine").appendTo(o), l.attr("preload", v), "string" == typeof r.playlist[0] ? l.attr("src", r.playlist[0]) : e.each(r.playlist[0], function (t, n) {
                    for (var i in n)n.hasOwnProperty(i) && l.append(e("<source />").attr({type: "video/" + i, src: n[i]}))
                }), d = new s(l)
            }
            var m = o.data("flowplayer");
            m && m.unload(), o.data("fp-player_id", o.data("fp-player_id") || p++);
            try {
                f = window.localStorage || f
            } catch (g) {
            }
            var h = this.currentStyle && "rtl" === this.currentStyle.direction || window.getComputedStyle && "rtl" === window.getComputedStyle(this, null).getPropertyValue("direction");
            h && o.addClass("is-rtl");
            var y = m || {conf: r, currentSpeed: 1, volumeLevel: "undefined" == typeof r.volume ? 1 * f.volume : r.volume, video: {}, disabled: !1, finished: !1, loading: !1, muted: "true" == f.muted || r.muted, paused: !1, playing: !1, ready: !1, splash: !1, rtl: h, load: function (t, n) {
                if (!(y.error || y.loading || y.disabled)) {
                    if (t = d.resolve(t), e.extend(t, a.pick(t.sources)), t.src) {
                        var i = e.Event("load");
                        o.trigger(i, [y, t, a]), i.isDefaultPrevented() ? y.loading = !1 : (a.load(t), e.isFunction(t) && (n = t), n && o.one("ready", n))
                    }
                    return y
                }
            }, pause: function (e) {
                return!y.ready || y.seeking || y.disabled || y.loading || (a.pause(), y.one("pause", e)), y
            }, resume: function () {
                return y.ready && y.paused && !y.disabled && (a.resume(), y.finished && (y.trigger("resume"), y.finished = !1)), y
            }, toggle: function () {
                return y.ready ? y.paused ? y.resume() : y.pause() : y.load()
            }, seek: function (t, n) {
                if (y.ready) {
                    if ("boolean" == typeof t) {
                        var r = .1 * y.video.duration;
                        t = y.video.time + (t ? r : -r)
                    }
                    t = i = Math.min(Math.max(t, 0), y.video.duration).toFixed(1);
                    var s = e.Event("beforeseek");
                    o.trigger(s, [y, t]), s.isDefaultPrevented() ? (y.seeking = !1, o.toggleClass("is-seeking", y.seeking)) : (a.seek(t), e.isFunction(n) && o.one("seek", n))
                }
                return y
            }, seekTo: function (e, t) {
                var n = void 0 === e ? i : .1 * y.video.duration * e;
                return y.seek(n, t)
            }, mute: function (e) {
                return void 0 === e && (e = !y.muted), f.muted = y.muted = e, f.volume = isNaN(f.volume) ? r.volume : f.volume, y.volume(e ? 0 : f.volume, !0), y.trigger("mute", e), y
            }, volume: function (e, t) {
                return y.ready && (e = Math.min(Math.max(e, 0), 1), t || (f.volume = e), a.volume(e)), y
            }, speed: function (t, n) {
                return y.ready && ("boolean" == typeof t && (t = r.speeds[e.inArray(y.currentSpeed, r.speeds) + (t ? 1 : -1)] || y.currentSpeed), a.speed(t), n && o.one("speed", n)), y
            }, stop: function () {
                return y.ready && (y.pause(), y.seek(0, function () {
                    o.trigger("stop")
                })), y
            }, unload: function () {
                return o.hasClass("is-embedding") || (r.splash ? (y.trigger("unload"), a.unload()) : y.stop()), y
            }, disable: function (e) {
                return void 0 === e && (e = !y.disabled), e != y.disabled && (y.disabled = e, y.trigger("disable", e)), y
            }};
            y.conf = e.extend(y.conf, r), e.each(["bind", "one", "unbind"], function (e, t) {
                y[t] = function (e, n) {
                    return o[t](e, n), y
                }
            }), y.trigger = function (e, t) {
                return o.trigger(e, [y, t]), y
            }, o.data("flowplayer") || o.bind("boot",function () {
                return e.each(["autoplay", "loop", "preload", "poster"], function (e, t) {
                    var n = l.attr(t);
                    void 0 !== n && (r[t] = n ? n : !0)
                }), (r.splash || o.hasClass("is-splash") || !flowplayer.support.firstframe) && (y.forcedSplash = !r.splash && !o.hasClass("is-splash"), y.splash = r.splash = r.autoplay = !0, o.addClass("is-splash"), l.attr("preload", "none")), e.each(c, function () {
                    this(y, o)
                }), a = flowplayer.engine[r.engine], a && (a = a(y, o)), a.pick(d.initialSources) ? y.engine = r.engine : e.each(flowplayer.engine, function (e) {
                    return e != r.engine ? (a = this(y, o), a.pick(d.initialSources) && (y.engine = e), !1) : void 0
                }), u.push(y), y.engine ? (r.splash ? y.unload() : y.load(), r.disabled && y.disable(), a.volume(y.volumeLevel), o.one("ready", n), void 0) : y.trigger("error", {code: flowplayer.support.flashVideo ? 5 : 10})
                ...
                r.splash && l.remove(), o.removeClass("is-loading"), y.loading = !1
            }).bind("ready unload",function (e) {
                var t = "ready" == e.type;
                o.toggleClass("is-splash", !t).toggleClass("is-ready", t), y.ready = t, y.splash = !t
                ...
                y.seeking = "beforeseek" == e.type, o.toggleClass("is-seeking", y.seeking)
            }).bind("ready pause resume unload finish stop",function (e, t, n) {
                y.paused = /pause|finish|unload|stop/.test(e.type), "ready" == e.type && (y.paused = "none" == r.preload, n && (y.paused = !n.duration || !r.autoplay && "none" != r.preload)), y.playing = !y.paused, o.toggleClass("is-paused", y.paused).toggleClass("is-playing", y.playing), y.load.ed || y.pause()
            }).bind("finish",function () {
                y.finished = !0
            }).bind("error", function () {
                l.remove()
            }), o.trigger("boot", [y, o]).data("flowplayer", y)
        })
    }, !function () {
        var t = flowplayer.support, n = e.browser, i = e("<video loop autoplay preload/>")[0], a = n.msie, o = navigator.userAgent, r = /iPad|MeeGo/.test(o) && !/CriOS/.test(o), s = /iPad/.test(o) && /CriOS/.test(o), l = /iP(hone|od)/i.test(o), d = /Android/.test(o) && !/Firefox/.test(o), u = /Android/.test(o) && /Firefox/.test(o), c = /Silk/.test(o), f = /IEMobile/.test(o), p = (r ? parseFloat(/Version\/(\d\.\d)/.exec(o)[1], 10) : 0, d ? parseFloat(/Android\ (\d\.\d)/.exec(o)[1], 10) : 0);
        e.extend(t, {subtitles: !!i.addTextTrack, fullscreen: !d && ("function" == typeof document.webkitCancelFullScreen && !/Mac OS X 10_5.+Version\/5\.0\.\d Safari/.test(o) || document.mozFullScreenEnabled || "function" == typeof document.exitFullscreen), inlineBlock: !(a && n.version < 8), touch: "ontouchstart"in window, dataload: !r && !l && !f, zeropreload: !a && !d, volume: !(r || d || l || c || s), cachedVideoTag: !(r || l || s || f), firstframe: !(l || r || d || c || s || f || u), inlineVideo: !l && !c && !f && (!d || p >= 3), hlsDuration: !n.safari || r || l || s, seekable: !r && !s});
        try {
            var v = a ? new ActiveXObject("ShockwaveFlash.ShockwaveFlash").GetVariable("$version") : navigator.plugins["Shockwave Flash"].description;
            v = v.split(/\D+/), v.length && !v[0] && (v = v.slice(1)), t.flashVideo = v[0] > 9 || 9 == v[0] && v[3] >= 115
        } catch (m) {
        }
        try {
        ...
        t.animation = function () {
            for (var t = ["", "Webkit", "Moz", "O", "ms", "Khtml"], n = e("<p/>")[0], i = 0; i < t.length; i++)if ("undefined" !== n.style[t[i] + "AnimationName"])return!0
        }()
        ...
        var l = {pick: function (t) {
            if (flowplayer.support.flashVideo) {
                ...
                if (n)return n;
                for (var i, a = 0; a < t.length; a++)if (i = t[a], /mp4|flv/.test(i.type))return i
            }
        }, load: function (l) {
            function d(e) {
            ...
            if (is_absolute = /^https?:/.test(c), u.length > 0 && flowplayer.support.video && u[0].pause(), u.remove(), is_absolute || s.rtmp || (c = e("<img/>").attr("src", c)[0].src), r)r.__play(c); else {
                a = "fp" + ("" + Math.random()).slice(3, 15);
                var f = {hostname: s.embedded ? s.hostname : location.hostname, url: c, callback: "jQuery." + a};
                i.data("origin") && (f.origin = i.data("origin")), is_absolute && delete s.rtmp, e.each(["key", "autoplay", "preload", "rtmp", "loop", "debug", "preload", "splash"], function (e, t) {
                    s[t] && (f[t] = s[t])
                }), f.rtmp && (f.rtmp = d(f.rtmp)), o = t(s.swf, f), o.prependTo(i), r = o[0], setTimeout(function () {
                    try {
                        if (!r.PercentLoaded())return i.trigger("error", [n, {code: 7, url: s.swf}])
                    } catch (e) {
                    }
                }, 5e3), e[a] = function (t, i) {
                    ...
                    switch (t) {
                        ...
                        case"buffered":
                            ...
                            break;
                        case"status":
                            n.trigger("progress", i.time), i.buffer <= l.bytes && !l.buffered ? (l.buffer = i.buffer / l.bytes * l.duration, n.trigger("buffer", l.buffer)) : l.buffered && n.trigger("buffered")
                    }
                    setTimeout(function () {
                        n.trigger(a, i)
                    }, 1)
        ...
        return n.bind("ready fullscreen fullscreen-exit", function (t) {
            ...
            if (n.conf.flashfit || /full/.test(t.type)) {
                var r, s, l = n.isFullscreen, u = l && F, c = !flowplayer.support.inlineBlock, f = l ? u ? screen.availWidth : d.width() : o, p = l ? u ? screen.availHeight : d.height() : a, v = u ? screen.width - screen.availWidth : 0, m = u ? screen.height - screen.availHeight : 0, g = c ? o : "", h = c ? a : "";
                (n.conf.flashfit || "fullscreen" === t.type) && (r = n.video.width / n.video.height, s = n.video.height / n.video.width, h = Math.max(s * f), g = Math.max(r * p), h = h > p ? g * s : h, h = Math.min(Math.round(h), p), g = g > f ? h * r : g, g = Math.min(Math.round(g), f), m = Math.max(Math.round((p + m - h) / 2), 0), v = Math.max(Math.round((f + v - g) / 2), 0)), e("object", i).css({width: g, height: h, marginTop: m, marginLeft: v})
            }
        }), l
    };
    var v, m = e("<video/>")[0], g = {ended: "finish", pause: "pause", play: "resume", progress: "buffer", timeupdate: "progress", volumechange: "volume", ratechange: "speed", seeked: "seek", loadeddata: "ready", error: "error", dataunavailable: "error"}, h = function (t) {
        return v ? v.attr({type: i(t.type), src: t.src}) : v = e("<video/>", {src: t.src, type: i(t.type), "class": "fp-engine", autoplay: "autoplay", preload: "none", "x-webkit-airplay": "allow"})
    };
    flowplayer.engine.html5 = function (t, i) {
                        ...
                        switch (r) {
                            case"ready":
                                ...
                                if (l = l || setInterval(function () {
                                    ...
                                    u.buffer && (u.buffer <= u.duration && !u.buffered ? t.trigger("buffer", d) : u.buffered || (u.buffered = !0, t.trigger("buffer", d).trigger("buffered", d), clearInterval(l), l = 0))
                                }, 250), !u.duration && !c.hlsDuration && "loadeddata" === a) {
                                    var m = function () {
                                        ...
                                        t.trigger(f, u), o.removeEventListener("durationchange", m)
                                    };
        ...
        return s = {pick: function (e) {
            ...
            if (p.splash && !d)u = h(n).prependTo(i), c.inlineVideo || u.css({position: "absolute", top: "-9999em"}), f.length && u.append(f.attr("default", "")), p.loop && u.attr("loop", "loop"), d = u[0]; else {
                d = u[0];
                var a = u.find("source");
            ...
            e("video.fp-engine", i).remove(), c.cachedVideoTag || (v = null), l = clearInterval(l), d = 0
        }}
    };
    var y = /\.(\w{3,4})(\?.*)?$/i;
    e.throttle = function (e, t) {
        ...
        return this.each(function () {
            var i, a, o, r, s, l, d, u, c = e(this), f = e(document), p = c.children(":last"), v = !1, m = function () {
            ...
            m(), c.data("api", w).bind("mousedown.sld touchstart", function (t) {
                if (t.preventDefault(), !i) {
                    var n = e.throttle(g, 100);
                    m(), w.dragging = !0, c.addClass("is-dragging"), g(h(t)), f.bind("mousemove.sld touchmove",function (e) {
        ...
        var u = i("progress"), c = i("buffer"), f = i("elapsed"), p = i("remaining"), v = i("waiting"), m = i("ratio"), g = i("speed"), h = i("duration"), y = m.css("paddingTop"), b = i("timeline").slider2(t.rtl), w = b.data("api"), k = (i("volume"), i("fullscreen")), C = i("volumeslider").slider2(t.rtl), x = C.data("api"), T = n.is(".fixed-controls, .no-toggle");
        ...
        t.bind("ready",function () {
            ...
            w.disable(t.disabled || !e), s.adaptiveRatio && a(t.video.height / t.video.width), h.add(p).html(d(e)), e >= 3600 && n.addClass("is-long") || n.removeClass("is-long"), x.slide(t.volumeLevel)
        }).bind("unload",function () {
            y || m.css("paddingTop", "")
            ...
            var e = t.disabled;
            w.disable(e), x.disable(e), n.toggleClass("is-disabled", t.disabled)
            ...
            (w.dragging || x.dragging) && n.addClass("is-mouseover").removeClass("is-mouseout")
    ...
    e(document).bind("keydown.fp", function (t) {
        var n = b, i = t.ctrlKey || t.metaKey || t.altKey, a = t.which, o = n && n.conf;
        if (n && o.keyboard && !n.disabled) {
            if (-1 != e.inArray(a, [63, 187, 191, 219]))return w.toggleClass(k), !1;
            if (27 == a && w.hasClass(k))return w.toggleClass(k), !1;
            if (!i && n.ready) {
                if (t.preventDefault(), t.shiftKey)return 39 == a ? n.speed(!0) : 37 == a && n.speed(!1), void 0;
                ...
                switch (a) {
                    ...
                    case 77:
                        ...
                        break;
                    case 27:
                        n[n.isFullscreen ? "fullscreen" : "unload"]()
                }
            }
        }
    }), flowplayer(function (t, n) {
    ...
    var C, x = e.browser.mozilla ? "moz" : "webkit", T = "fullscreen", S = "fullscreen-exit", F = flowplayer.support.fullscreen, _ = "function" == typeof document.exitFullscreen;
    e(document).bind(_ ? "fullscreenchange" : x + "fullscreenchange", function (t) {
        var n = e(document.webkitCurrentFullScreenElement || document.mozFullScreenElement || document.fullscreenElement || t.target);
        n.length && !C ? C = n.trigger(T, [n]) : (C.trigger(S, [C]), C = null)
    }), flowplayer(function (t, n) {
        if (t.conf.fullscreen) {
            var i, a = e(window), o = {pos: 0, play: !1};
            t.isFullscreen = !1, t.fullscreen = function (r) {
                return t.disabled ? void 0 : (void 0 === r && (r = !t.isFullscreen), r && (i = a.scrollTop()), F ? r ? _ ? n[0].requestFullscreen() : (n[0][x + "RequestFullScreen"](Element.ALLOW_KEYBOARD_INPUT), !e.browser.safari || document.webkitCurrentFullScreenElement || document.mozFullScreenElement || n[0][x + "RequestFullScreen"]()) : _ ? document.exitFullscreen() : document[x + "CancelFullScreen"]() : ("flash" === t.engine && t.conf.rtmp && (o = {pos: t.video.time, play: t.playing}), t.trigger(r ? T : S, [t])), t)
            };
            var r;
            n.bind("mousedown.fs", function () {
                ...
                n.removeClass("is-fullscreen"), t.isFullscreen = !1, a.scrollTop(i)
            }).bind("ready", function () {
                o.pos && !isNaN(o.pos) && setTimeout(function () {
                    t.play(), t.seek(o.pos), o.play || setTimeout(function () {
                        t.pause()
                    }, 100), o = {pos: 0, play: !1}
                }, 250)
            })
        ...
        t.play = function (n) {
            return void 0 === n ? t.resume() : "number" != typeof n || t.conf.playlist[n] ? ("number" != typeof n && t.load.apply(null, arguments), t.unbind("resume.fromfirst"), t.video.index = n, t.load("string" == typeof t.conf.playlist[n] ? t.conf.playlist[n].toString() : t.conf.playlist[n].map(function (t) {
                return e.extend({}, t)
            })), t) : t
        }, t.next = function (e) {
            e && e.preventDefault();
            ...
            i < t.conf.playlist.length || o.loop ? (i = i === t.conf.playlist.length ? 0 : i, n.removeClass("is-finished"), setTimeout(function () {
                t.play(i)
            })) : (n.addClass("is-playing"), t.one("resume.fromfirst", function () {
                return t.play(0), !1
            }))
        });
        var s = !1;
        if (t.conf.playlist.length) {
            ...
            l.length || (l = e('<div class="fp-playlist"></div>'), e("video", n).after(l)), l.empty(), e.each(t.conf.playlist, function (t, n) {
                var i;
                if ("string" == typeof n)i = n; else for (var a in n[0])if (n[0].hasOwnProperty(a)) {
                    i = n[0][a];
                    break
                }
        ...
        if (i().length) {
            ...
            var d = i().filter("[data-cuepoints]").length;
            t.bind("load",function (i, o, s) {
                var l = a().removeClass(r), u = l.attr("data-index"), c = s.index = t.video.index || 0, f = e('a[data-index="' + c + '"]', n).addClass(r), p = c == t.conf.playlist.length - 1;
                n.removeClass("video" + u).addClass("video" + c).toggleClass("last-video", p), s.index = o.video.index = c, s.is_last = o.video.is_last = p, d && (t.cuepoints = f.data("cuepoints"))
    ...
    flowplayer(function (t, n) {
        function i(e) {
            n[0].className = n[0].className.replace(M, " "), e >= 0 && n.addClass("cue" + e)
        }

        var a = 0;
        t.cuepoints = t.conf.cuepoints || [], t.bind("progress",function (e, o, r) {
            if (a && .015 > r - a)return a = r;
            a = r;
            for (var s, l = t.cuepoints || [], d = 0; d < l.length; d++)s = l[d], isNaN(s) || (s = {time: s}), s.time < 0 && (s.time = t.video.duration + s.time), s.index = d, Math.abs(s.time - r) < .125 * t.currentSpeed && (i(d), n.trigger("cuepoint", [t, s]))
        ...
        if (!flowplayer.support.subtitles || (t.subtitles = a.length && a[0].track, !o.nativesubtitles || "html5" != o.engine)) {
            ...
            if (s) {
                e.get(s,function (n) {
                    for (var a, o, s, l, d = 0, u = n.split("\n"), c = u.length, f = {}; c > d; d++)if (o = r.exec(u[d])) {
                        for (a = u[d - 1], s = "<p>" + u[++d] + "</p><br/>"; e.trim(u[++d]) && d < u.length;)s += "<p>" + u[d] + "</p><br/>";
                ...
                var l, d = e("<div class='fp-subtitle'/>", n).appendTo(n);
                t.bind("cuepoint",function (e, t, n) {
                    n.subtitle ? (l = n.index, d.html(n.subtitle.text).addClass("fp-active")) : n.subtitleEnd && d.removeClass("fp-active")
                }).bind("seek", function (n, i, a) {
                    e.each(t.cuepoints || [], function (e, n) {
                        var i = n.subtitle;
                        i && l != n.index && (a >= n.time && a <= i.endTime ? t.trigger("cuepoint", n) : d.removeClass("fp-active"))
                    })
                })
            }
        }
        ...
        function i() {
            if (o && "undefined" != typeof _gat) {
                ...
                e._setAllowLinker(!0), e._trackEvent("Video / Seconds played", t.engine + "/" + i.type, n.attr("title") || i.src.split("/").slice(-1)[0].replace(y, ""), Math.round(o / 1e3)), o = 0
            }
        }
    ...
    var E = /IEMobile/.test(f);
    (flowplayer.support.touch || E) && flowplayer(function (t, n) {
        var i = /Android/.test(f) && !/Firefox/.test(f) && !/Opera/.test(f), a = /Silk/.test(f);
        if (i) {
            t.conf.videoTypePreference = "mp4";
            var o = t.load;
            t.load = function () {
        ...
        n.bind("touchmove",function () {
            ...
            return r ? (r = !1, void 0) : t.playing && !n.hasClass("is-mouseover") ? (n.addClass("is-mouseover").removeClass("is-mouseout"), !1) : (t.paused && n.hasClass("is-mouseout") && t.toggle(), t.paused && E && e("video", n)[0].play(), void 0)
        }), t.conf.native_fullscreen && (e.browser.webkit || e.browser.safari) && (t.fullscreen = function () {
            var t = e("video", n);
        ...
        if (t.conf.embed !== !1) {
            ...
            t.embedCode = function () {
                ...
                e.each(["origin", "analytics", "logo", "key", "rtmp"], function (e, t) {
                    i[t] && s.attr("data-" + t, i[t])
                }), e.each(a.sources, function (t, n) {
                    l.append(e("<source/>", {type: "video/" + n.type, src: n.src}))
                });
                var d = {src: "//embed.flowplayer.org/5.4.2/embed.min.js"};
