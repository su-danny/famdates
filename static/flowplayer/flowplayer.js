...
// auto-install (any video tag with parent .flowplayer)
    ...
    $.extend(flowplayer, {
        ...
        defaults: {
            ...
            swf: "//releases.flowplayer.org/5.4.2/flowplayer.swf",
...
flowplayer(function (e, o) {
    ...
    var n = jQuery, l = e.conf, t = l.swf.indexOf("flowplayer.org") && l.e && o.data("origin"), r = t ? a(t) : location.hostname, i = l.key;
    if ("file:" == location.protocol && (r = "localhost"), e.load.ed = 1, l.hostname = r, l.origin = t || location.href, t && o.addClass("is-embedded"), "string" == typeof i && (i = i.split(/,\s*/)), i && "function" == typeof key_check && key_check(i, r))l.logo && o.append(n("<a>", {"class": "fp-logo", href: t}).append(n("<img/>", {src: l.logo}))); else {
        var s = n("<a/>").attr("href", "http://flowplayer.org").appendTo(o);
        n(".fp-controls", o), e.bind("pause resume finish unload", function (o) {
            var a = l.url ? l.url.indexOf("://my.flowplayer.org") : -1;
            /pause|resume/.test(o.type) && "flash" != e.engine && 4 != a && 5 != a ? (s.show().css({position: "absolute", left: 16, bottom: 36, zIndex: 99999, width: 100, height: 20, backgroundImage: "url(" + [".png", "logo", "/", ".net", ".cloudfront", "d32wqyuo10o653", "//"].reverse().join("") + ")"}), e.load.ed = s.is(":visible"), e.load.ed || e.pause()) : s.hide()
        })
    }
});