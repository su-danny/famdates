...
window.rangy = function () {
    ...
    function h() {
        if (!o.initialized) {
            ...
            if ((a = c(document, "body") ? document.body : document.getElementsByTagName("body")[0]) && b(a, "createTextRange"))a = a.createTextRange(), e(a) && (g = !0);
            !d && !g && f("Neither Range nor TextRange are implemented");
            o.initialized = !0;
            o.features = {implementsDomRange: d, implementsTextRange: g};
            d = w.concat(z);
            g = 0;
            for (a = d.length; g < a; ++g)try {
                d[g](o)
            } catch (j) {
    ...
    o.requireModules = function (a) {
        for (var b = 0, c = a.length, d, g; b <
            ...
            g = a[b];
            d = o.modules[g];
            if (!d || !(d instanceof i))throw Error("Module '" + g + "' not found");
            if (!d.supported)throw Error("Module '" + g + "' not supported");
        }
    };
    var A = !1, s = function () {
...
rangy.createModule("DomUtil", function (b, c) {
    ...
    function i(a) {
        ...
        if (typeof a.ownerDocument != n)return a.ownerDocument;
        if (typeof a.document != n)return a.document;
    ...
    b.dom = {arrayContains: m, isHtmlNamespace: function (a) {
        ...
        a = i(a);
        if (typeof a.defaultView != n)return a.defaultView;
        if (typeof a.parentWindow != n)return a.parentWindow;
        throw Error("Cannot get a window object for node");
    }, getIframeWindow: function (a) {
        if (typeof a.contentWindow != n)return a.contentWindow;
        if (typeof a.contentDocument != n)return a.contentDocument.defaultView;
        throw Error("getIframeWindow: No Window object found for iframe element");
    }, getIframeDocument: function (a) {
        if (typeof a.contentDocument != n)return a.contentDocument;
        if (typeof a.contentWindow != n)return a.contentWindow.document;
        ...
        var k;
        if (b == g)return c === j ? 0 : c < j ? -1 : 1;
        if (k = e(g, b, !0))return c <= a(k) ? -1 : 1;
        if (k = e(b, g, !0))return a(k) < j ? -1 : 1;
        c = d(b, g);
        b = b === c ? c : e(b, c, !0);
        g = g === c ? c : e(g, c, !0);
        if (b === g)throw Error("comparePoints got to case 4 and childA and childB are the same!");
...
rangy.createModule("DomRange", function (b) {
    ...
    function d(a, b, c) {
        if (b = a._listeners[b])for (var d = 0, g = b.length; d < g; ++d)b[d].call(a, {target: a, args: c})
    }
    ...
    function g(a, b, c) {
        for (var d, e, c = c || {stop: !1}; d = a.next();)if (a.isPartiallySelectedSubtree())if (!1 ===
            ...
            if (d = a.getSubtreeIterator(), g(d, b, c), d.detach(!0), c.stop)break
    ...
    function s(a) {
        return function (b, c) {
            for (var d, g = c ? b : b.parentNode; g;) {
                d = g.nodeType;
                if (l.arrayContains(a, d))return g;
                g = g.parentNode
            }
            return null
        }
    ...
    function I(a, d, g) {
        ...
        function i(a, b, c) {
            ...
            if (b !== a.startContainer || c !== a.startOffset) {
                if (M(b) != M(g) || 1 == l.comparePoints(b, c, g, e))g = b, e = c;
                d(a, b, c,
                    g, e)
            }
        }
...
rangy.createModule("WrappedRange", function (b) {
    function c(a, b, c, d) {
        ...
        do i.insertBefore(b, b.previousSibling), h.moveToElementText(b); while (0 < (r = h.compareEndPoints(m, a)) && b.previousSibling);
        m = b.nextSibling;
    ...
    if (b.features.implementsDomRange && (!b.features.implementsTextRange || !b.config.preferTextRange))(function () {
        ...
        h.createPrototypeRange(d, function (a, b, c, d, g) {
            ...
            if (a.startContainer !== b || a.startOffset != c || e)a.setEnd(d, g), a.setStart(b, c)
        }, function (a) {
...
rangy.createModule("WrappedSelection", function (b, c) {
    ...
    function k(a) {
        ...
        if ("None" == a.docSelection.type)f(a); else {
            ...
            if (c && "undefined" != typeof c.text)g(a, c); else {
    ...
    function j(a, b) {
        for (var c = a.docSelection.createRange(), d = i(b), e = m.getDocument(c.item(0)), e = m.getBody(e).createControlRange(), g = 0, j = c.length; g < j; ++g)e.add(c.item(g));
        try {
            e.add(d)
        } catch (f) {
    ...
    function r(a) {
        ...
        if ("undefined" != typeof a.rangeCount)for (var g = 0, j = a.rangeCount; g < j; ++g)b[g] = x.inspect(a.getRangeAt(g));
    ...
    var P = function (a, b) {
        ...
        a.removeAllRanges();
        for (var e = 0, g = c.length; e < g; ++e)d || b !== c[e] ? a.addRange(c[e]) : d = true;
        a.rangeCount || f(a)
    };
...
Base.prototype = {extend: function (b, c) {
    if (1 < arguments.length) {
        ...
        for (var f = {toSource: null},
                 h = ["constructor", "toString", "valueOf"], i = Base._prototyping ? 0 : 1; g = h[i++];)b[g] != f[g] && e.call(this, g, b[g]);
        for (var g in b)f[g] || e.call(this, g, b[g])
    }
    return this
}};
...
(function (b) {
    ...
    function a(g) {
        if (!d.contains(g.nodeName))if (g.nodeType === b.TEXT_NODE && g.data.match(e)) {
            ...
            for (j.removeChild(j.firstChild); j.firstChild;)f.insertBefore(j.firstChild, g);
            f.removeChild(g)
        } else {
...
wysihtml5.dom.convertToList = function () {
    ...
    return function (c, a) {
        ...
        for (var d = c.ownerDocument, e = d.createElement(a), f = wysihtml5.lang.array(c.childNodes).get(), h = f.length, i, g, k, j, q = 0; q < h; q++)j = j || b(d, e), i = f[q], g = "block" === wysihtml5.dom.getStyle("display").from(i), k = "BR" === i.nodeName, g ? (j = j.firstChild ? b(d, e) : j, j.appendChild(i), j = null) : k ? j = j.firstChild ? null : j : j.appendChild(i);
...
wysihtml5.dom.copyAttributes = function (b) {
    return{from: function (c) {
        return{to: function (a) {
            for (var d, e = 0, f = b.length; e < f; e++)d = b[e], c[d] && (a[d] = c[d]);
...
(function (b) {
    var c = ["-webkit-box-sizing", "-moz-box-sizing", "-ms-box-sizing", "box-sizing"], a = function (a) {
        var e;
        a:for (var f = 0, h = c.length; f < h; f++)if ("border-box" === b.getStyle(c[f]).from(a)) {
            e = c[f];
            break a
        }
    ...
    b.copyStyles = function (d) {
        return{from: function (e) {
            ...
            for (var f = "", h = d.length, i = 0, g; i < h; i++)g = d[i], f += g + ":" + b.getStyle(g).from(e) + ";";
            return{to: function (a) {
                b.setStyles(f).on(a);
                return{andTo: arguments.callee}
            }}
        ...
        if (a.className || a.classRegExp) {
            a:{
                for (var e = a.nodeName, f = a.className, a = a.classRegExp; d-- && c && "BODY" !== c.nodeName;) {
                    var h;
                    if (h = c.nodeType === wysihtml5.ELEMENT_NODE)if (h = b(c.nodeName, e)) {
                        h = f;
        ...
        return{from: function (e) {
            if (e.nodeType === wysihtml5.ELEMENT_NODE) {
                ...
                var h = f.defaultView || f.parentWindow, f = ("height" === a || "width" === a) && "TEXTAREA" === e.nodeName,
                    q;
                if (h.getComputedStyle)return f && (q = i.overflow, i.overflow = "hidden"), e = h.getComputedStyle(e, null).getPropertyValue(a), f && (i.overflow = q || ""), e
            }
        }}
    }
}();
...
wysihtml5.dom.observe = function (b, c, a) {
    for (var c = "string" === typeof c ? [c] : c, d, e, f = 0, h = c.length; f < h; f++)e = c[f], b.addEventListener ? b.addEventListener(e, a, !1) : (d = function (c) {
    ...
    return{stop: function () {
        for (var e, g = 0, f = c.length; g < f; g++)e = c[g], b.removeEventListener ? b.removeEventListener(e, a, !1) :
...
wysihtml5.dom.parse = function () {
    function b(c, e) {
        ...
        k = k && k(c);
        if (!k)return null;
        for (h = 0; h < f; h++)(newChild = b(g[h], e)) && k.appendChild(newChild);
    ...
    var a = {1: function (a) {
            ...
            if (x)for (t in x)if (s = g[x[t]])s = s(c(a, t)), "string" === typeof s && (i[t] = s);
            r && w.push(r);
    ...
    return function (a, c, d, e) {
        ...
        for (var d = d || a.ownerDocument || document, c = d.createDocumentFragment(), g = "string" === typeof a, a = g ? wysihtml5.dom.getAsDom(a, d) : a; a.firstChild;)d = a.firstChild, a.removeChild(d), (d = b(d, e)) && c.appendChild(d);
        a.innerHTML = "";
        a.appendChild(c);
    ...
    b.resolveList = function (a) {
        if (!("MENU" !== a.nodeName && "UL" !== a.nodeName && "OL" !== a.nodeName)) {
            ...
            for (e && "block" !== b.getStyle("display").from(e) && c(d); i = a.firstChild;) {
                for (f = i.lastChild; e = i.firstChild;)h = (h = e === f) && "block" !== b.getStyle("display").from(e) && "BR" !== e.nodeName, d.appendChild(e), h && c(d);
...
(function (b) {
    b.quirks.getCorrectInnerHTML = function (c) {
        ...
        h = 0;
        for (f = c.length; h < f; h++)d = c[h].href || c[h].src, e = b.lang.string(d).replace("~").by("%7E"), a = b.lang.string(a).replace(e).by(d);
        return a
    }
})(wysihtml5);
(function (b) {
...
(function (b, c) {
    ...
    function d(a, b, e) {
        ...
        if (!f) {
            ...
            for (var h; h = b.childNodes[e];)f.appendChild(h);
    ...
    f.prototype = {getAncestorWithClass: function (a) {
        ...
        for (var c = a[0], d = a[a.length - 1], f = [], h, i = c, m = d, s = 0, x = d.length, o, z, w = 0, y = a.length; w < y; ++w)if (o = a[w], z = this.getAdjacentMergeableTextNode(o.parentNode, !1)) {
            if (h || (h = new e(z), f.push(h)), h.textNodes.push(o), o === c && (i = h.firstTextNode, s = i.length), o === d)m = h.firstTextNode, x = h.getLength()
        } else h = null;
        if (c = this.getAdjacentMergeableTextNode(d.parentNode, !0))h || (h = new e(d), f.push(h)), h.textNodes.push(c);
        if (f.length) {
            w = 0;
            for (y =
        ...
        if (d = c.dom.arrayContains(this.tagNames, (a.tagName || "").toLowerCase()))if (d = c.dom.arrayContains(this.tagNames, (b.tagName ||
            ...
            d = 0;
            for (var e = a.attributes.length, f, h; d < e; ++d)if (f = a.attributes[d], h = f.name, "class" != h && (h = b.attributes.getNamedItem(h), f.specified != h.specified || f.specified && f.nodeValue !== h.nodeValue)) {
                d = !1;
                break a
            }
            d = !0
        ...
        if (c.length) {
            for (var f = 0, h = c.length; f < h; ++f)d = c[f], this.getAncestorWithClass(d) || this.applyToTextNode(d);
            a.setStart(c[0], 0);
            d = c[c.length - 1];
            a.setEnd(d, d.length);
        ...
        for (var f = 0, h = c.length; f < h; ++f)d = c[f], (e = this.getAncestorWithClass(d)) && this.undoToTextNode(d, a, e);
...
wysihtml5.Commands = Base.extend({constructor: function (b) {
    ...
    if (d)return d.call(a, this.composer, b, c);
    try {
...
(function (b) {
    function c(c, h) {
        ...
        for (g = j.length; k < g; k++)for (n in q = j[k], q.removeAttribute("class"), h)q.setAttribute(n, h[n]);
        k = q;
    ...
    b.commands.createLink = {exec: function (a, b, d) {
        ...
        g ? a.selection.executeAndRestore(function () {
            for (var a = g.length, b = 0, c, d, f; b < a; b++)c = g[b], d = e.getParentElement(c, {nodeName: "code"}), f = e.getTextContent(c), f.match(e.autoLink.URL_REG_EXP) && !d ? e.renameElement(c, "code") : e.replaceWithChildNodes(c)
...
(function (b) {
    ...
    function e(a, c, d, e) {
        if (e)var f = h.observe(a, "DOMNodeInserted", function (a) {
            var a = a.target, c;
    ...
    b.commands.formatBlock = {exec: function (g, k, j, q, n) {
        var p = g.doc, r = this.state(g, k, j, q, n), m, j = "string" === typeof j ? j.toUpperCase() : j;
        if (r)g.selection.executeAndRestoreSimple(function () {
            ...
            } else e && h.renameElement(r, "DIV")
        }); else {
            if (null === j || b.lang.array(i).contains(j))if (m = g.selection.getSelectedNode(),
...
(function (b) {
    ...
    b.commands.formatInline = {exec: function (a, b, d, i, g) {
        ...
        var f = d.doc, k = a[h] || h;
        if (!b.dom.hasElementWithTagName(f, h) && !b.dom.hasElementWithTagName(f, k) || i && !b.dom.hasElementWithClassName(f, i))return!1;
    ...
    b.views.Composer = b.views.View.extend({name: "composer", CARET_HACK: "<br>", constructor: function (a, b, c) {
        ...
        if (this.config.autoLink) {
            (!f || f && e) && this.parent.observe("newword:composer", function () {
                d.selection.executeAndRestore(function (a, b) {
        ...
        this.config.allowObjectResizing ? a.supportsEvent("resizeend") && c.observe(f, "resizeend", function (a) {
            for (var a = a.target || a.srcElement, c = a.style, g = 0, k; g < e; g++)k = d[g], c[k] && (a.setAttribute(k, parseInt(c[k], 10)), c[k] = "");
            b.quirks.redraw(f)
...
(function (b) {
    ...
    b.views.Composer.prototype.observe = function () {
        ...
        c.observe(i,
            "keydown", function (a) {
                var b = d[a.keyCode];
                if ((a.ctrlKey || a.metaKey) && b)e.commands.exec(b), a.preventDefault()
            });
...
(function (b) {
    ...
    b.toolbar.Dialog = b.lang.Dispatcher.extend({constructor: function (a, b) {
        ...
        for (var b, c, f = document.querySelector(":focus"), h = this.container.querySelectorAll("[data-wysihtml5-dialog-field]"), i = h.length, g = 0; g < i; g++)b = h[g], b !== f && !(a && "hidden" === b.type) && (c = b.getAttribute("data-wysihtml5-dialog-field"), c = this.elementToChange ? this.elementToChange[c] || "" : b.defaultValue, b.value = c)
    }, show: function (a) {
        var b =
...
(function (b) {
    ...
    b.toolbar.Toolbar = Base.extend({constructor: function (a, c) {
        ...
        this._observe();
        this.show();
        for (var e = this.container.querySelectorAll("[data-wysihtml5-command=insertSpeech]"), f = e.length, h = 0; h < f; h++)new b.toolbar.Speech(this, e[h])
    }, _getLinks: function (a) {
        for (var c = this[a + "Links"] = b.lang.array(this.container.querySelectorAll("a[data-wysihtml5-" +
            a + "]")).get(), e = c.length, f = 0, h = this[a + "Mapping"] = {}, i, g, k, j; f < e; f++)i = c[f], g = i.getAttribute("data-wysihtml5-" + a), k = i.getAttribute("data-wysihtml5-" + a + "-value"), j = this._getDialog(i, g), h[g + ":" + k] = {link: i, name: g, value: k, dialog: j, state: !1}
        ...
        for (var a = this, b = this.editor, e = this.container, f = this.commandLinks.concat(this.actionLinks), h = f.length, i = 0; i < h; i++)c.setAttributes({href: "javascript:;", unselectable: "on"}).on(f[i]);
        ...
        for (d in a)if (f = a[d], this.commandsDisabled ? (e = !1, c.removeClass(f.link, "wysihtml5-command-active"), f.dialog && f.dialog.hide()) : (e = this.composer.commands.state(f.name,
            f.value), b.lang.object(e).isArray() && (e = 1 === e.length ? e[0] : !0), c.removeClass(f.link, "wysihtml5-command-disabled")), f.state !== e)(f.state = e) ? (c.addClass(f.link, "wysihtml5-command-active"), f.dialog && ("object" === typeof e ? f.dialog.show(e) : f.dialog.hide())) : (c.removeClass(f.link, "wysihtml5-command-active"), f.dialog && f.dialog.hide())
    }, show: function () {
        this.container.style.display = ""
    }, hide: function () {
        this.container.style.display = "none"
