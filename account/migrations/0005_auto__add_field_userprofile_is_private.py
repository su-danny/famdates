...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'UserProfile.is_private'
        db.add_column('account_userprofile', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.is_private'
        db.delete_column('account_userprofile', 'is_private')
