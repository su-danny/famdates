...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventJoin'
        db.create_table('account_eventjoin', (
        ...
        db.send_create_signal('account', ['EventJoin'])


    def backwards(self, orm):
        # Deleting model 'EventJoin'
        db.delete_table('account_eventjoin')
