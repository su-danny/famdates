...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('account_interestgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('account', ['InterestGroup'])

        # Adding field 'Interest.group'
        db.add_column('account_interest', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.InterestGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'InterestGroup'
        db.delete_table('account_interestgroup')

        # Deleting field 'Interest.group'
        db.delete_column('account_interest', 'group_id')
    ...
    models = {
        ...
        'events.event': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interests': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['account.Interest']", 'null': 'True', 'blank': 'True'}),
