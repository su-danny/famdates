...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.current_registration_step'
        db.add_column('account_userprofile', 'current_registration_step',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.current_registration_step'
        db.delete_column('account_userprofile', 'current_registration_step')
