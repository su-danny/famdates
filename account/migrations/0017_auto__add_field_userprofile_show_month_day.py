...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_month_day'
        db.add_column('account_userprofile', 'show_month_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_month_day'
        db.delete_column('account_userprofile', 'show_month_day')
