...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'UserProfile.hide_birthday'
        db.add_column('account_userprofile', 'hide_birthday',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.hide_birthday'
        db.delete_column('account_userprofile', 'hide_birthday')
