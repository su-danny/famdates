...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.attn'
        db.add_column('account_userprofile', 'attn',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.attn'
        db.delete_column('account_userprofile', 'attn')
    ...
    models = {
        ...
        'events.event': {
            ...
            'frequency': ('django.db.models.fields.SmallIntegerField', [], {'default': '-1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interval': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'name': ('django.db.models.fields.TextField', [], {'default': "'Unknow Event'", 'null': 'True', 'blank': 'True'}),
