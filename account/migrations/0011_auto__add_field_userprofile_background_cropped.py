...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'UserProfile.background_cropped'
        db.add_column('account_userprofile', 'background_cropped',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.background_cropped'
        db.delete_column('account_userprofile', 'background_cropped')
