...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column('account_userprofile', 'email_notification',
                      self.gf('django.db.models.fields.CharField')(default='enabled', max_length=50),
                      keep_default=False)

        # Adding field 'UserProfile.receive_email_from_groups'
        db.add_column('account_userprofile', 'receive_email_from_groups',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.receive_email_for_new_message'
        db.add_column('account_userprofile', 'receive_email_for_new_message',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('account_userprofile', 'email_notification')

        # Deleting field 'UserProfile.receive_email_from_groups'
        db.delete_column('account_userprofile', 'receive_email_from_groups')

        # Deleting field 'UserProfile.receive_email_for_new_message'
        db.delete_column('account_userprofile', 'receive_email_for_new_message')
