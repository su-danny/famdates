...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'Card'
        db.create_table('tiger_card', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fingerprint', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('last4', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('exp_month', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('exp_year', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('address_line1', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('address_line2', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('address_city', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('address_state', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('address_zip', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tiger.Customer'])),
        ))
        db.send_create_signal('tiger', ['Card'])

        # Adding model 'Customer'
        db.create_table('tiger_customer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stripe_id', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('tiger', ['Customer'])


    def backwards(self, orm):
        # Deleting model 'Card'
        db.delete_table('tiger_card')

        # Deleting model 'Customer'
        db.delete_table('tiger_customer')
    ...
    models = {
        ...
        'tiger.card': {
            ...
            'address_line2': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'address_state': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'address_zip': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
