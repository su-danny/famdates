...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('post_post_media', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('post', models.ForeignKey(orm['post.post'], null=False)),
            ('mediafile', models.ForeignKey(orm['fileupload.mediafile'], null=False))
        ))
        db.create_unique('post_post_media', ['post_id', 'mediafile_id'])


    def backwards(self, orm):
        # Removing M2M table for field media on 'Post'
        db.delete_table('post_post_media')
    ...
    models = {
        ...
        'post.post': {
            ...
            'media': ('django.db.models.fields.related.ManyToManyField', [],
                      {'to': "orm['fileupload.MediaFile']", 'symmetrical': 'False'}),
            'video': (
