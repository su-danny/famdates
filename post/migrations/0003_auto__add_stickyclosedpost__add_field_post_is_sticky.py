...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'StickyClosedPost'
        db.create_table('post_stickyclosedpost', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['post.Post'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('post', ['StickyClosedPost'])

        # Adding field 'Post.is_sticky'
        db.add_column('post_post', 'is_sticky',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StickyClosedPost'
        db.delete_table('post_stickyclosedpost')

        # Deleting field 'Post.is_sticky'
        db.delete_column('post_post', 'is_sticky')
    ...
    models = {
        ...
        'post.post': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_sticky': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'location': (
