...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Post.wall'
        db.add_column('post_post', 'wall',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='wall_posts',
                                                                            null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.wall'
        db.delete_column('post_post', 'wall_id')
