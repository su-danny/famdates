...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('group_group', (
            ...
            ('group_type', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            (
    ...
    def backwards(self, orm):
        ...
        db.delete_table('group_usergroup')
