...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('group_message', (
            ...
            ('parent',
             self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='reply_messages', null=True,
                                                                   to=orm['group.Message'])),
            ('created_at',
             self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
            ('read_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('group', ['Message'])


    def backwards(self, orm):
        # Deleting model 'Message'
        db.delete_table('group_message')
    ...
    models = {
        ...
        'group.usergroup': {
            ...
            'invitation_code': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
